...
?>
<div id="fullscreen-section" class="bg-bright-orange min-h-screen min-w-screen w-full flex items-center justify-center z-30 fixed pointer-events-none hidden">
	<div class="container">
		<div class="grid grid-cols-12 lg:gap-x-10 gap-x-5">
				<div class="lg:col-start-3">
					<h2 class="rw-sentence h2 text-white min-w-[1000px]">The Next  
...
<div id="<?php echo esc_attr( $block_id ); ?>" class="<?= esc_attr( $block_class )?> bg-bright-orange dark-section relative">
		...
		<div class="grid grid-cols-12 gap-x-5 md:gap-x-10 relative">
			<div class="row-span-2 col-span-12 md:col-span-6 flex items-end md:pb-11 order-2 md:order-1 mt-[60px] md:mt-0">
				<div class="sticky bottom-[44px] left-0 right-0 w-full">
					<div class="border border-bright-orange-700 p-5 flex gap-x-5 md:max-w-[376px] justify-between">
						<div>
			...
			<div class="col-span-12 md:col-span-6 min-h-screen md:min-h-screen flex items-end lg:pb-11 order-0 md:order-2 pb-[15px] md:pb-0">
				<h1 class="h2 text-white">Delivering Award Winning Workforce Management Solutions</h1>
			</div>
			<div class="col-span-12 md:col-start-7 md:col-end-13 lg:py-[120px] order-3 mt-8 pb-24">
				...
				<div class="mb-10">
					<a class="flex text-white h5 justify-between w-full items-center  pt-[10px] md:pt-[17px] pb-[30px] md:pb-10 border-t border-bright-orange-700" href="#link">
	...
	<div class="z-[1] hero__bg right-0 absolute top-0 left-1/2 transform -translate-x-1/2 -translate-0 w-full px-5 md:max-w-2xl">
		<svg class="animate animate-up" width="778" height="783" viewBox="0 0 778 783"  preserveAspectRatio="xMinYMin" fill="none" xmlns="http://www.w3.org/2000/svg">
