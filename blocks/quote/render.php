...
?>
<div id="<?php echo esc_attr( $block_id ); ?>" class="<?= esc_attr( $block_class )?> bg-white">
	<div class="container lg:px-0">
		<div class="min-h-screen flex flex-col justify-center lg:py-30 lg:px-[133px]">
			<div class="animate animate-up">
				<div class="w-10 h-10 flex items-center justify-center border border-dark-warm-grey text-dark-warm-grey mx-auto">
